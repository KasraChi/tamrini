    ...
    options: {
      plugins: {
        ...
        title: {
          display: true,
          text: 'وضعیت ثبت نام',
          font: { family: 'Vazir, Tahoma, sans-serif', size: 16, weight: 'bold' },
      ...
      scales: {
        y: {
          ticks: { precision: 0, font: { family: 'Vazir', size: 12 } },
...
// فراخوانی چارت با classCode دلخواه (یا بدون classCode)
function updateChartWithClassCode(classCode) {
  let url = '/api/registeringStatus';
  if (classCode) {
...
// لود اولیه چارت بدون فیلتر یا با مقدار پیشفرض
function init() {
  updateChartWithClassCode();
}
